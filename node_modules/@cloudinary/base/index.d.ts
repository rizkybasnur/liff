...
declare const CloudinaryBaseSDK: {
    ...
    Actions: {
        ...
        Animated: {
            edit: typeof import("./actions/animated").edit;
        };
    };
    Qualifiers: {
        TextDecoration: {
    ...
    createCloudinaryLegacyURL: typeof createCloudinaryLegacyURL;
};
export { Transformation, ImageTransformation, VideoTransformation, Actions, Qualifiers, Cloudinary, CloudinaryImage, CloudinaryVideo, CloudinaryFile, createCloudinaryLegacyURL, CloudinaryBaseSDK, CloudinaryBaseSDK as default };
